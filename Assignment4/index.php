...
function displayCard($students, $i)
{
    $birthMonth = $students['month'];
    $birthDay = $students['day'];
    $birthYear = $students['year'];
    ...
    <div class="col-12 col-sm-6 col-lg-3">
        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s"
            ...
            <!--Team Thumb-->
            <div class="advisor_thumb"><a href="detail.php?name=<?= $students['name'] ?>&index=<?= $i ?>"><img
                            src="https://bootdey.com/img/Content/avatar/avatar<?= $i + 1 ?>.png" alt=""></a>
                <div class="social-info"><a href="detail.php?name=<?= $students['name'] ?>&index=<?= $i ?>"><i
                                class="fa fa-facebook"></i></a><a
                            href="detail.php?name=<?= $students['name'] ?>&index=<?= $i ?>"><i
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-8 col-lg-6">
            ...
            <div class="section_heading text-center wow fadeInUp" data-wow-delay="0.2s"
                ...
                <a style="font-size: 20px; float: right;" href="create.php"><?= 'Create User' ?></a>
