  ...
  <?php
	  if(isset($_POST['submit'])) {
		if(isset($_POST['is_primary']))
			...
			$_POST['is_primary'] = 0;
		$addressFunctions->modifyAddress($_GET['id'], $_GET['user_id'], $_POST['is_primary'], $_POST['street'], $_POST['city'], $_POST['zip'], $_POST['state'], $_POST['delivery_instructions']);
	  }
	  if(isset($_POST['delete'])) 
		$addressFunctions->deleteAddress($_GET['id'], $_GET['user_id']);
	?>
</main>
