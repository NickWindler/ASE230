...
$stmt = $db->query('SELECT * FROM meals WHERE ID = ' . $_GET['id']);
$meal = $stmt->fetch();
?>
...
<main class="form-signin">
  ...
  <?php
	  if(isset($_POST['submit'])) 
		$mealFunctions->modifyMeal($_GET['id'], $_GET['rID'], $_POST['name'], $_POST['price'], $_POST['description'], $_POST['url'], $_GET['rName']);
	  if(isset($_POST['delete'])) 
		$mealFunctions->deleteMeal($_GET['id'], $_GET['rID'], $_GET['rName']);
	?>
</main>
