...
<main class="form-signin">
  ...
  <?php
	  if(isset($_POST['submit'])) 
		$restaurantFunctions->modifyRestaurant($restaurant['ID'], $_POST['type'], $_POST['name'], $_POST['street'], $_POST['city'], $_POST['zip'], $_POST['state'], $_POST['rating'], $_POST['url']);
	  if(isset($_POST['delete'])) 
		$restaurantFunctions->deleteRestaurant($restaurant['ID']);
	?>
</main>
