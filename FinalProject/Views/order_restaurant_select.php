...
$restaurantArray = $restaurantFunctions->getRestaurantsByType($_GET['typeID']);
?>
<!doctype html>
<html lang="en">
  <head>
...
<main class="container" >
  <div class="bg-light p-5 rounded" style="height: 100%;">
	...
	<?php if(isset($_POST['next'])) header('Location:order_meal_select.php?typeID='.$_GET['typeID'].'&rID='.$_POST['restaurant']);?>
