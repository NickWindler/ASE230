...
$addressArray = $addressFunctions->getAddressesForUser($row['ID']);
$paymentArray = $paymentFunctions->getPaymentOptionsForUser($row['ID']);
$orderArray = $orderFunctions->getOrdersForUser($row['ID']);
?>
<!doctype html>
<html lang="en">
  <head>
